...
static void updateRelays() {
  ...
  if (out1 != prevOut1) { prevOut1 = out1; logRelayChange(1, out1); anyChanged = true; }
  if (out2 != prevOut2) { prevOut2 = out2; logRelayChange(2, out2); anyChanged = true; }
  if (out3 != prevOut3) { prevOut3 = out3; logRelayChange(3, out3); anyChanged = true; }
  if (out4 != prevOut4) { prevOut4 = out4; logRelayChange(4, out4); anyChanged = true; }
